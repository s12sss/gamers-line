...
export const TIER_CONFIG: Record<TierLabel, {
  ...
  S: {
    color: '#111318',
    bg: 'rgba(255,130,112,0.06)',
    border: 'rgba(255,130,112,0.45)',
    labelBg: '#ff8270',
    label: '第一候補',
  ...
  A: {
    color: '#111318',
    bg: 'rgba(255,204,120,0.06)',
    border: 'rgba(255,204,120,0.4)',
    labelBg: '#ffcc78',
    label: '有力候補',
  ...
  B: {
    color: '#111318',
    bg: 'rgba(255,238,120,0.05)',
    border: 'rgba(255,238,120,0.35)',
    labelBg: '#ffee78',
    label: '条件次第',
  ...
  C: {
    color: '#111318',
    bg: 'rgba(204,255,120,0.04)',
    border: 'rgba(204,255,120,0.3)',
    labelBg: '#ccff78',
    label: '要確認',
