...
const ROWS: Row[] = [
  ...
  { name: 'ビッグローブ光', tag: 'コラボ光 · 全国', ping: 18, cb: '最大 65,000円', cbNum: 65000, cbNote: '※クーポン「BWS」入力で65,000円（全員35,000円+増額30,000円）', feature: '工事費実質無料 / 解約金最大4万円還元', penaltyCover: '最大4万円', href: 'https://px.a8.net/svt/ejp?a8mat=4B3K2L+4FK6WI+B4+2NBPO2' },
  ...
  { name: 'GameWith光', tag: 'ゲーム専用帯域 · 全国', ping: 16, cb: '—', cbNum: 0, feature: '1ヶ月無料', penaltyCover: 'なし', href: 'https://h.accesstrade.net/sp/cc?rk=0100pyge00os5p' },
];
