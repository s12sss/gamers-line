...
const ROWS: Row[] = [
  ...
  { name: 'ビッグローブ光', tag: 'コラボ光 · 全国', ping: 18, cb: '最大 65,000円', cbNum: 65000, cbNote: undefined, feature: '工事費実質無料 / 解約金最大4万円還元', penaltyCover: '最大4万円', href: 'https://px.a8.net/svt/ejp?a8mat=4B3K2L+4FK6WI+B4+2NBPO2' },
